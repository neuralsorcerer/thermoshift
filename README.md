...
paired outcomes. It verifies the sample's current file integrity and labels its
saved scientific-validation profiles as historical. For a release generated by the
current source and runtime, it performs a fresh full validation instead:
